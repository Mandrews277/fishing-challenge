...
@export var MIN_STRESS : float = 0.3
@export var MAX_STRESS : float = 0.335
...
func _ready() -> void:
	...
	for i in range(LINKS):
		...
		if i > 0:
			...
			var slider_joint = get_node("RopeStart/SliderJoint3D")
			slider_joint.node_a = rope_link_instance.get_path()
